    ...
    **/
    eventos()
    {
        document.getElementById("cancelar_cfdi_btn").addEventListener("click",(e) => {
            ...
            this.#motivo_cancelacion=document.getElementById("motivo_cancelacion").value;
            this.#folio_sustitucion=document.getElementById("folio_sustitucion").value;
            this.cancelar();
        });
    }
    /**
    ...
    **/
    cancelar()
    {
        var cancelar={
            ...
            "folio_sustitucion": this.#folio_sustitucion
        };
