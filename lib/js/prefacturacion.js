...
class Prefacturacion
{
    ...
    **/
    eventos()
    {
        document.getElementById("boton_obtener_prefactura").addEventListener("click",(e) => {
            if(document.getElementById("json_cfdi")!=null)
            {
                this.#infoEmisor["json_cfdi"] = document.getElementById("json_cfdi").value;
            }
            if(document.getElementById("rfc_emisor")!=null)
            {
    ...
    /**
     * Description. Método para establecer el CFDI
     * @author Tecnología Globalbtek <Fiscus CFDI> globalbtek.com | app.fiscus.mx
     * @date   2022-04-08
     * @param  {object} cfdi 
     * @return {void}
    **/
    setCfdi(cfdi)
    {
        this.#infoEmisor["json_cfdi"] = cfdi;
    }
    /**
     * Description. Método para establecer el CFDI
     * @author Tecnología Globalbtek <Fiscus CFDI> globalbtek.com | app.fiscus.mx
    ...
    **/
     setRfcEmisor(rfc)
     {
        this.#infoEmisor["rfc_emisor"] = rfc;
     }
