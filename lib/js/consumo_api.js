...
class ConsumirApi {
  #usuario = "";
  #password = "";
  #url = "https://app.fiscus.mx/index.php/Api?peticion=";
  #omitir_token = false;
  /**
   * Description. Método para establecer si se omitirá el token (petición de obtener Token)
   * @author Tecnología Globalbtek <Fiscus CFDI> globalbtek.com | app.fiscus.mx
   * @date   2022-04-08
   * @param  {boolean} omitir
   * @return {void}
   **/
  setOmitirToken(omitir)
  {
    if(omitir)
    {
      this.#omitir_token=true;
    }
    else
    {
      this.#omitir_token=false;
    }
  }
  /**
